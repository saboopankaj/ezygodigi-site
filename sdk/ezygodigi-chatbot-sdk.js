...
#eg-chat-btn { 
  ...
  cursor:pointer; z-index:2147483647 !important; /* MAX */
...
#eg-chat-box { 
  position:fixed; bottom:0; right:20px; width:360px; height:100dvh; 
  max-height: 100dvh; background:#fff; border-radius:20px 20px 0 0; 
  box-shadow:0 -15px 40px rgba(0,0,0,0.15); display:none; 
  flex-direction:column; z-index:2147483647 !important; /* MAX */
  font-family: 'Inter', -apple-system, sans-serif; overflow:hidden; 
  border: 1px solid rgba(0,0,0,0.05); padding-top: env(safe-area-inset-top);
}
